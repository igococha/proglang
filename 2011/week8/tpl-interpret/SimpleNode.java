...
public class SimpleNode implements Node {
  ...
  /* Added by DB to do interpreting. */

  /* Stack for expression calculations. */
  
  protected static java.util.Stack stack = new java.util.Stack();

  /* This will be overridden by all AST nodes. */

  public void interpret () { /* Error if this is executed */
     System.out.println("TPL Interpreter: Simple Node version panic");
  }
}
