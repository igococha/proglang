...
/* CW additions by DB start here. */
  static final public Statement DoWhileStatement() throws ParseException {
  Statement s;
  Exp e;
    jj_consume_token(DO);
    s = Statement();
    ...
    jj_consume_token(RPAREN);
    jj_consume_token(SEMICOLON);
    {if (true) return new DoWhile(s,e);}
    throw new Error("Missing return statement in function");
  }
  ...
  CatchList cl = new CatchList();
    ...
    jj_consume_token(RBRACE);
    {if (true) return new Try(sl1,cl,sl2);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Catch Catch() throws ParseException {
  Type t;
  Identifier i;
  Statement s;
  StatementList sl=new StatementList();
    ...
    jj_consume_token(RBRACE);
    {if (true) return new Catch(t,i,sl);}
    throw new Error("Missing return statement in function");
  }
...
/* CW additions by DB end here */
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x1000000,0x1000000,0x80800000,0x0,0x80800000,0x0,0x80800000,0x60002000,0x0,0x80800000,0x2000,0x60000000,0x60002000,0x0,0x60002000,0x60002000,0x60002000,0x10400200,0x10400200,0x0,0x10000000,0x400200,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x20000,0x8,0x20000,0x8,0x20000,0x25a00,0x100000,0x20000,0x0,0x5a00,0x25a00,0x8000,0x25a00,0x25a00,0x25a00,0x30184,0x30184,0x100000,0x30180,0x4,};
   }
