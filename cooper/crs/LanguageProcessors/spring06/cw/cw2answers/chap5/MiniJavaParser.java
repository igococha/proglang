 ...
 ************************************/
  ...
  static final public Exp CompareGTExpression() throws ParseException {
  Exp e1,e2;
    e1 = PrimaryExpression();
    jj_consume_token(GT);
    e2 = PrimaryExpression();
  ...
  static final public Exp DivideExpression() throws ParseException {
  Exp e1,e2;
    e1 = PrimaryExpression();
  ...
  static final public Exp ShortCutIfElseExpression() throws ParseException {
  Exp e1,e2,e3;
    e1 = PrimaryExpression();
    jj_consume_token(SIF);
    e2 = PrimaryExpression();
    jj_consume_token(SELSE);
    e3 = PrimaryExpression();
    {if (true) return new ShortCutIfElse(e1,e2,e3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final private boolean jj_3R_64() {
    if (jj_3R_16()) return true;
    if (jj_scan_token(SIF)) return true;
    if (jj_3R_16()) return true;
    if (jj_scan_token(SELSE)) return true;
    if (jj_3R_16()) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x20000000,0x20000000,0x10000000,0x0,0x10000000,0x0,0x10000000,0x2000,0x0,0x10000000,0x2000,0x0,0x2000,0x8000200,0x8000200,0x0,0x0,0x8000200,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x40020,0x200,0x40020,0x200,0x40020,0x4801c,0x200000,0x40020,0x0,0x801c,0x4801c,0x66102,0x66102,0x200000,0x66002,0x100,};
   }
