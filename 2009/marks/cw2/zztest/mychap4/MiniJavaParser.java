 ...
 ************************************/
  ...
  static final public Statement RepeatUntilStatement() throws ParseException {
  Exp e;
  Statement s;
    ...
    jj_consume_token(RPAREN);
    jj_consume_token(SEMICOLON);
    {if (true) return new RepeatUntil(e,s);}
    throw new Error("Missing return statement in function");
  }

  static final public Statement ThrowStatement() throws ParseException {
  Exp e;
    jj_consume_token(THROW);
    e = Expression();
    jj_consume_token(SEMICOLON);
    {if (true) return new Throw(e);}
    throw new Error("Missing return statement in function");
  }

  static final public Statement TryStatement() throws ParseException {
  Statement b1;
  Statement b2;
  Statement b3;
  FormalList parameterlist = new FormalList();
  StatementList blist = new StatementList();
  Formal f;
    jj_consume_token(56);
    b1 = Block();
    label_10:
    while (true) {
      ...
      jj_consume_token(RPAREN);
      b2 = Block();
                                                    parameterlist.addElement(f); blist.addElement(b2);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case CATCH:
        ;
        break;
    ...
    b3 = Block();
    {if (true) return new Try(b1, b3, parameterlist, blist);}
    throw new Error("Missing return statement in function");
  }
  ...
  Exp e1,e2;
    ...
    e2 = PrimaryExpression();
    {if (true) return new Division(e1,e2);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Exp MethodCall() throws ParseException {
  Exp e;
  Identifier i;
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x4000000,0x4000000,0x2000000,0x0,0x2000000,0x0,0x2000000,0x80002000,0x0,0x2000000,0x2000,0x80000000,0x80002000,0x0,0x40800200,0x40800200,0x0,0x40000000,0x800200,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x100008,0x80,0x100008,0x80,0x100008,0x1112003,0x800000,0x100008,0x0,0x1012003,0x1112003,0x40000,0x181840,0x181840,0x800000,0x181800,0x40,};
   }
