...
public class Interpreter implements Visitor {
  ...
  public int visit(RepeatUntilStm s) throws VisitorException {
	int v =s.exp1.accept(this);
        checkExpType(s.exp1,s.exp1,valType,Type.BOOL);
	Iterator<Stm> iterator;
	while (v==0) {
	    iterator = s.body.iterator();
	    while (iterator.hasNext()){
